...
// Funcion de utilidad para imprimir un vector
template<typename T>
...
int main() 
{
    ...
    //Esta linea de codigo utiliza la clase ramdon__device para declarar una variable llamada n_aleatorio para determinar numeros aleatorios
